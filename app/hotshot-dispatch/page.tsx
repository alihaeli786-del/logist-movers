...
export const metadata: Metadata = {
  title: "Hotshot Dispatch Services | Logist Movers",
  description:
    "Professional hotshot dispatch services for owner-operators across the USA. Load searching, rate negotiation, broker communication, route planning, and dispatch support.",
  alternates: {
    canonical: "/hotshot-dispatch",
  },
  openGraph: {
    type: "website",
    url: "/hotshot-dispatch",
    title: "Hotshot Dispatch Services | Logist Movers",
    description:
      "Professional hotshot dispatch support for owner-operators across the United States.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Logist Movers Hotshot Dispatch Services",
      },
    ],
  },
  twitter: {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: "https://www.logistmovers.com/hotshot-dispatch",
    },
  ],
};
...
/>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-2 lg:px-10 lg:py-28">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Keep your hotshot truck moving with professional dispatch
              support. Logist Movers helps hotshot carriers with load searching,
              rate negotiation, broker communication, paperwork, route planning,
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#091625] shadow-2xl">
            <div className="relative h-[320px] sm:h-[420px]">
              <Image
                src="/equipment/hotshot.webp"
                alt="Hotshot truck dispatch services"
                fill
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 leading-7 text-slate-400">
            Hotshot freight often requires flexibility, fast communication, and
            smart lane selection. Our dispatch team helps you evaluate suitable
            opportunities while handling broker communication and load
            coordination.
          </p>
        </div>
          ...
          {[
            {
              ...
              text: "We search hotshot freight opportunities based on your trailer type, preferred lanes, availability, and schedule.",
            },
            {
              title: "Rate Negotiation",
              text: "We communicate with brokers and negotiate rates while considering mileage, route, and operating costs.",
            },
            {
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-2 lg:px-10">
          <div>
            ...
            <p className="mt-6 leading-8 text-slate-300">
              Hotshot operations can vary by trailer type, load size, preferred
              lanes, home-time requirements, schedule, and operating costs.
              These factors all matter when evaluating freight opportunities.
            </p>

            <p className="mt-5 leading-8 text-slate-400">
              Our team focuses on suitable freight and clear communication
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-10">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-3xl font-black sm:text-4xl">
            How Our Hotshot Dispatch Works
          </h2>
        </div>
          ...
          {[
            {
              ...
              text: "Share your trailer type, preferred lanes, availability, schedule, and operating goals.",
            },
            {
              number: "02",
              title: "We Search & Negotiate",
              text: "Our team searches suitable hotshot opportunities and communicates with brokers on your behalf.",
            },
            {
              number: "03",
...
<section className="border-t border-white/10 bg-[#091625]">
  <div className="mx-auto max-w-5xl px-5 py-20 lg:px-10">
    <div className="text-center">
      ...
      <h2 className="mt-4 text-3xl font-black sm:text-4xl">
        Hotshot Dispatch FAQs
      </h2>

      <p className="mx-auto mt-5 max-w-2xl leading-7 text-slate-400">
        Common questions carriers ask about our hotshot dispatch services.
      </p>
    </div>
    ...
    <div className="mt-12 space-y-4">
      {[
        {
          question: "What does a hotshot dispatcher do?",
          answer:
            "A hotshot dispatcher helps carriers search for suitable freight, communicate with brokers, negotiate rates, coordinate load details, assist with paperwork, and plan routes based on the truck and trailer setup.",
        },
        {
          question: "What types of hotshot trailers can you dispatch?",
          answer:
            "We can search freight opportunities based on your specific hotshot setup, including trailer type, dimensions, capacity, preferred lanes, and operating requirements.",
        },
        {
          question: "Can you find local, regional, and OTR hotshot loads?",
          answer:
            "Yes. We can search local, regional, and OTR hotshot opportunities based on your preferred lanes, availability, schedule, and operating goals.",
        },
        {
          question: "Do I have to accept every hotshot load you find?",
          answer:
        ...
        {
          question: "Do you negotiate hotshot freight rates?",
          answer:
        ...
        <div className="mx-auto max-w-5xl px-5 py-20 text-center">
          <div className="rounded-3xl border border-blue-400/20 bg-gradient-to-br from-blue-500/10 to-cyan-400/5 px-6 py-14 sm:px-12">
            ...
            <h2 className="mt-4 text-3xl font-black sm:text-5xl">
              Ready to Keep Your Hotshot Moving?
            </h2>

            <p className="mx-auto mt-5 max-w-2xl leading-7 text-slate-300">
              Talk with Logist Movers about your truck, trailer, preferred
              lanes, and hotshot dispatch needs.
            </p>
