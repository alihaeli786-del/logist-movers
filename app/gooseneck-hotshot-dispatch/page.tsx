...
export const metadata: Metadata = {
  title: "Gooseneck Hotshot Dispatch Services | Logist Movers",
  description:
    "Professional gooseneck hotshot dispatch services for owner-operators across the USA. Load searching, rate negotiation, broker communication, route planning, and dispatch support.",
  alternates: {
    canonical: "/gooseneck-hotshot-dispatch",
  },
  openGraph: {
    type: "website",
    url: "/gooseneck-hotshot-dispatch",
    title: "Gooseneck Hotshot Dispatch Services | Logist Movers",
    description:
      "Professional gooseneck hotshot dispatch support for owner-operators across the United States.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Logist Movers Gooseneck Hotshot Dispatch Services",
      },
    ],
  },
  twitter: {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: "https://www.logistmovers.com/gooseneck-hotshot-dispatch",
    },
  ],
};
export default function GooseneckHotshotDispatchPage() {
  return (
...
/>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-2 lg:px-10 lg:py-28">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Keep your gooseneck hotshot moving with professional dispatch
              support. Logist Movers helps carriers with load searching, rate
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#091625] shadow-2xl">
            <div className="relative h-[320px] sm:h-[420px]">
              <Image
                src="/equipment/gooseneck-hotshot.webp"
                alt="Gooseneck hotshot truck dispatch services"
                fill
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-10">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-sm font-bold uppercase tracking-[0.2em] text-cyan-300">
            Gooseneck Hotshot Dispatch Support
          </p>
          ...
          <p className="mt-5 leading-7 text-slate-400">
            Gooseneck hotshot carriers often handle flexible freight across
            different lanes and distances. Our dispatch team helps you find
            suitable opportunities while managing broker communication and load
            coordination.
          </p>
        </div>
          ...
          {[
            {
              ...
              text: "We search gooseneck hotshot freight opportunities based on your trailer specifications, preferred lanes, availability, and schedule.",
            },
            {
              title: "Rate Negotiation",
              text: "We communicate with brokers and negotiate rates while considering mileage, route, equipment, and operating costs.",
            },
            {
      ...
      <section className="border-y border-white/10 bg-[#091625]">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-2 lg:px-10">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-cyan-300">
              Built for Gooseneck Hotshot Carriers
            </p>
            ...
            <p className="mt-6 leading-8 text-slate-300">
              Gooseneck hotshot operations can vary by trailer length, freight
              size, route preferences, schedule, home-time requirements, and
              operating costs. These factors matter when evaluating available
              freight.
            </p>

            <p className="mt-5 leading-8 text-slate-400">
              Our team focuses on suitable opportunities, lane strategy, and
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-10">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-3xl font-black sm:text-4xl">
            How Our Gooseneck Hotshot Dispatch Works
          </h2>
        </div>
          ...
          {[
            {
              ...
              text: "Share your gooseneck trailer specifications, preferred lanes, availability, schedule, and operating goals.",
            },
            {
              number: "02",
...
<section className="border-t border-white/10 bg-[#091625]">
  <div className="mx-auto max-w-5xl px-5 py-20 lg:px-10">
    <div className="text-center">
      ...
      <h2 className="mt-4 text-3xl font-black sm:text-4xl">
        Gooseneck Hotshot Dispatch FAQs
      </h2>

      <p className="mx-auto mt-5 max-w-2xl leading-7 text-slate-400">
        Common questions carriers ask about our gooseneck hotshot dispatch
        services.
      </p>
    </div>
    ...
    <div className="mt-12 space-y-4">
      {[
        {
          question: "What does a gooseneck hotshot dispatcher do?",
          answer:
            "A gooseneck hotshot dispatcher helps carriers search for suitable freight, communicate with brokers, negotiate rates, coordinate load details, assist with paperwork, and plan routes based on the truck and trailer setup.",
        },
        {
          question: "What gooseneck trailer sizes can you dispatch?",
          answer:
            "We can search freight opportunities based on your specific gooseneck trailer dimensions, cargo capacity, equipment setup, preferred lanes, and operating requirements.",
        },
        {
          question:
            "Can you find local, regional, and OTR gooseneck hotshot loads?",
          answer:
        ...
        {
          question: "Do you negotiate gooseneck hotshot freight rates?",
          answer:
        ...
        <div className="mx-auto max-w-5xl px-5 py-20 text-center">
          <div className="rounded-3xl border border-blue-400/20 bg-gradient-to-br from-blue-500/10 to-cyan-400/5 px-6 py-14 sm:px-12">
            ...
            <h2 className="mt-4 text-3xl font-black sm:text-5xl">
              Ready to Keep Your Gooseneck Hotshot Moving?
            </h2>

            <p className="mx-auto mt-5 max-w-2xl leading-7 text-slate-300">
              Talk with Logist Movers about your truck, gooseneck trailer,
              preferred lanes, and dispatch needs.
            </p>
