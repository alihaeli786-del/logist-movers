...
export const metadata: Metadata = {
  title: "Box Truck Dispatch Services | Logist Movers",
  description:
    "Professional box truck dispatch services for owner-operators and fleets across the USA. Load searching, rate negotiation, broker communication, route planning, and dispatch support.",
  alternates: {
    canonical: "/box-truck-dispatch",
  },
  openGraph: {
    type: "website",
    ...
    title: "Box Truck Dispatch Services | Logist Movers",
    description:
      "Professional box truck dispatch support for owner-operators and fleets across the United States.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Logist Movers Box Truck Dispatch Services",
      },
    ],
  },
  twitter: {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: "https://www.logistmovers.com/box-truck-dispatch",
    },
  ],
};
...
/>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-2 lg:px-10 lg:py-28">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Keep your box truck moving with professional dispatch support.
              Logist Movers helps box truck carriers with load searching, rate
              negotiation, broker communication, route planning, paperwork, and
              dispatch coordination across the United States.
            </p>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#091625] shadow-2xl">
            <div className="relative h-[320px] sm:h-[420px]">
              <Image
                src="/equipment/box-truck.webp"
                alt="Box truck dispatch services"
                fill
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 leading-7 text-slate-400">
            Box truck carriers often need flexible local, regional, and OTR
            opportunities. Our dispatch team helps you search suitable freight
            while managing broker communication and load coordination.
          </p>
        </div>
          ...
          {[
            {
              ...
              text: "We search box truck freight opportunities based on your truck size, preferred lanes, availability, and schedule.",
            },
            {
              title: "Rate Negotiation",
              text: "We communicate with brokers and negotiate rates while considering distance, route, and operating costs.",
            },
            {
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-2 lg:px-10">
          <div>
            ...
            <p className="mt-6 leading-8 text-slate-300">
              Box truck operations can vary by truck size, freight type,
              preferred lanes, home-time requirements, and operating costs.
              These factors matter when evaluating suitable opportunities.
            </p>

            <p className="mt-5 leading-8 text-slate-400">
              Our team focuses on suitable freight opportunities and clear
              communication instead of simply sending random loads.
            </p>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-10">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-3xl font-black sm:text-4xl">
            How Our Box Truck Dispatch Works
          </h2>
        </div>
          ...
          {[
            {
              ...
              text: "Share your truck size, preferred lanes, availability, schedule, and operating goals.",
            },
            {
              number: "02",
              title: "We Search & Negotiate",
              text: "Our team searches suitable box truck opportunities and communicates with brokers on your behalf.",
            },
            {
              number: "03",
...
<section className="border-t border-white/10 bg-[#091625]">
  <div className="mx-auto max-w-5xl px-5 py-20 lg:px-10">
    <div className="text-center">
      ...
      <h2 className="mt-4 text-3xl font-black sm:text-4xl">
        Box Truck Dispatch FAQs
      </h2>

      <p className="mx-auto mt-5 max-w-2xl leading-7 text-slate-400">
        Common questions carriers ask about our box truck dispatch services.
      </p>
    </div>
    ...
    <div className="mt-12 space-y-4">
      {[
        {
          question: "What does a box truck dispatcher do?",
          answer:
            "A box truck dispatcher helps carriers search for suitable freight, communicate with brokers, negotiate rates, coordinate load details, assist with paperwork, and plan routes based on the truck size and carrier preferences.",
        },
        {
          question: "Can you find loads for different box truck sizes?",
          answer:
            "Yes. We can search opportunities based on your box truck size, cargo capacity, preferred lanes, schedule, and operating requirements.",
        },
        {
          question: "Can you find local, regional, and OTR box truck loads?",
          answer:
            "Yes. We can search local, regional, and OTR box truck opportunities based on your preferred lanes, truck availability, schedule, and operating goals.",
        },
        {
          question: "Do I have to accept every box truck load you find?",
          answer:
        ...
        {
          question: "Do you negotiate box truck freight rates?",
          answer:
            "Yes. Our dispatch team communicates with brokers and negotiates rates while considering mileage, route, operating costs, and your preferences.",
        },
        {
