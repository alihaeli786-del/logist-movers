...
export const metadata: Metadata = {
  title: "Flatbed Dispatch Services | Logist Movers",
  description:
    "Professional flatbed dispatch services for owner-operators and fleets across the USA. Load searching, rate negotiation, broker communication, paperwork, and dispatch support.",
  alternates: {
    canonical: "/flatbed-dispatch",
  },
  openGraph: {
    type: "website",
    ...
    title: "Flatbed Dispatch Services | Logist Movers",
    description:
      "Professional flatbed dispatch support for owner-operators and fleets across the United States.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Logist Movers Flatbed Dispatch Services",
      },
    ],
  },
  twitter: {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: "https://www.logistmovers.com/flatbed-dispatch",
    },
  ],
};
...
/>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-2 lg:px-10 lg:py-28">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Keep your flatbed moving with professional dispatch support.
              Logist Movers helps flatbed carriers with load searching, rate
              negotiation, broker communication, paperwork, route planning,
              and dispatch coordination across the United States.
            </p>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#091625] shadow-2xl">
            <div className="relative h-[320px] sm:h-[420px]">
              <Image
                src="/equipment/flatbed.webp"
                alt="Flatbed truck dispatch services"
                fill
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 leading-7 text-slate-400">
            Flatbed freight can involve different load sizes, routes, and
            operating requirements. Our team helps you evaluate suitable
            opportunities while handling broker communication and dispatch
            coordination.
          </p>
        </div>
          ...
          {[
            {
              ...
              text: "We search flatbed freight opportunities based on your preferred lanes, equipment, truck availability, and schedule.",
            },
            {
              title: "Rate Negotiation",
              text: "We communicate with brokers and negotiate rates while considering route distance and operating requirements.",
            },
            {
              title: "Broker Communication",
              text: "Our team helps manage broker communication throughout the load booking and dispatch process.",
            },
            {
              title: "Carrier Setup",
            ...
            },
            {
              ...
              text: "We help evaluate local, regional, and OTR opportunities based on your preferred operating areas.",
            },
            {
              title: "Dispatch Support",
              text: "Get responsive help with load details, appointments, paperwork, and broker communication.",
            },
          ].map((service) => (
            <div
              key={service.title}
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-2 lg:px-10">
          <div>
            ...
            <p className="mt-6 leading-8 text-slate-300">
              Flatbed carriers may operate across local, regional, or OTR
              lanes. Your preferred routes, truck availability, operating
              costs, schedule, and freight preferences all matter when
              evaluating loads.
            </p>

            <p className="mt-5 leading-8 text-slate-400">
              Our team focuses on communication and lane strategy instead of
              simply sending random freight opportunities.
            </p>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-10">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-3xl font-black sm:text-4xl">
            How Our Flatbed Dispatch Works
          </h2>
        </div>
          ...
          {[
            {
              ...
              text: "Share your preferred lanes, flatbed availability, schedule, equipment details, and operating goals.",
            },
            {
              number: "02",
              title: "We Search & Negotiate",
              text: "Our team searches suitable freight opportunities and communicates with brokers on your behalf.",
            },
            {
              number: "03",
  ...
  <div className="mx-auto max-w-5xl px-5 py-20 lg:px-10">
    <div className="text-center">
      ...
      <p className="mx-auto mt-5 max-w-2xl leading-7 text-slate-400">
        Common questions carriers ask about our flatbed dispatch services.
      </p>
    </div>
    ...
    <div className="mt-12 space-y-4">
      {[
        {
          question: "What does a flatbed dispatcher do?",
          answer:
            "A flatbed dispatcher helps carriers search for suitable freight, communicate with brokers, negotiate rates, coordinate load details, assist with paperwork, and plan routes based on the carrier's preferences.",
        },
        {
          question: "Do I have to accept every flatbed load you find?",
          answer:
        ...
        {
          question: "Can you find local, regional, and OTR flatbed loads?",
          answer:
            "Yes. We can search local, regional, and OTR flatbed opportunities based on your preferred lanes, equipment, schedule, truck availability, and operating goals.",
        },
        {
          question: "Do you negotiate flatbed freight rates?",
          answer:
        ...
        {
          question: "Can owner-operators and small fleets use your flatbed dispatch service?",
          answer:
            "Yes. Logist Movers provides flatbed dispatch support for owner-operators as well as small and growing fleets across the United States.",
        },
      ].map((faq) => (
        <div
          key={faq.question}
