...
export const metadata: Metadata = {
  title: "Step Deck Dispatch Services | Logist Movers",
  description:
    "Professional step deck dispatch services for owner-operators and fleets across the USA. Load searching, rate negotiation, broker communication, paperwork, and dispatch support.",
  alternates: {
    canonical: "/step-deck-dispatch",
  },
  openGraph: {
    type: "website",
    url: "/step-deck-dispatch",
    title: "Step Deck Dispatch Services | Logist Movers",
    description:
      "Professional step deck dispatch support for owner-operators and fleets across the United States.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Logist Movers Step Deck Dispatch Services",
      },
    ],
  },
  twitter: {
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-2 lg:px-10 lg:py-28">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Keep your step deck moving with professional dispatch support.
              Logist Movers helps step deck carriers with load searching, rate
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#091625] shadow-2xl">
            <div className="relative h-[320px] sm:h-[420px]">
              <Image
                src="/equipment/step-deck.webp"
                alt="Step deck truck dispatch services"
                fill
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 leading-7 text-slate-400">
            Step deck freight can involve specialized dimensions and route
            requirements. Our dispatch team helps search suitable freight and
            coordinate communication with brokers.
          </p>
        </div>
          ...
          {[
            {
              ...
              text: "We search step deck freight opportunities based on your preferred lanes, trailer specifications, availability, and schedule.",
            },
            {
              title: "Rate Negotiation",
              text: "We communicate with brokers and negotiate rates while considering distance, equipment, and operating requirements.",
            },
            {
            ...
            {
              title: "Carrier Setup",
              text: "We assist with broker setup packets and commonly required carrier documents before booking freight.",
            },
            {
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-2 lg:px-10">
          <div>
            ...
            <p className="mt-6 leading-8 text-slate-300">
              Step deck carriers can handle freight that requires more
              flexibility than standard trailer configurations. Preferred
              lanes, trailer dimensions, schedule, operating costs, and truck
              availability all matter when evaluating freight.
            </p>

            <p className="mt-5 leading-8 text-slate-400">
              Our team focuses on suitable opportunities and clear
          ...
          {[
            {
              ...
              text: "Share your preferred lanes, step deck specifications, truck availability, schedule, and operating goals.",
            },
            {
              number: "02",
